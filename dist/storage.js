...
var StorageService = class {
  ...
  async saveToSupabase(data) {
    try {
      ...
      const { error } = await supabase_config_default.from("user_data").upsert({
        user_id: user.id,
        data,
  ...
  async loadFromSupabase() {
    try {
      ...
      const { data, error } = await supabase_config_default.from("user_data").select("data").eq("user_id", user.id).single();
      if (error) throw error;
...
var storage_default = storageService;
export {
